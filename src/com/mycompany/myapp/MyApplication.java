...
import com.mycompany.GUI.addprod;
import com.mycompany.GUI.getallcat;
import com.mycompany.GUI.getallprod;
import com.mycompany.GUI.myproducts;
...
public class MyApplication {
   ...
   private Font numbersFont;
    ...
    public void start() throws IOException {
        ...
        getallcat c = new getallcat();
        getallprod p = new getallprod();
        addprod ap = new addprod();
        myproducts mp = new myproducts();
        Form f  = new Form("Esprit <3", new BorderLayout());
        ...
        f.getToolbar().addMaterialCommandToSideMenu("Home",FontImage.MATERIAL_ACCOUNT_CIRCLE, ev->{home h=new home(); h.getF().show();});
        ...
        f.add(BorderLayout.CENTER, clock);
        clock.start();
        f.show();
    }
